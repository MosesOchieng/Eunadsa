...
<head>
    ...
    <title>EUNASDA ~ Human Nutrition</title>
    <!--
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="products.php">Certificates</a>
                                </li>
                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="add-product.html" class="btn btn-small btn-primary">What is next ?</a>
                            </div>
                        </div>
            ...
            <footer class="row tm-mt-small">
                <div class="col-12 font-weight-light">
                    <p class="d-inline-block tm-bg-black text-white py-2 px-4">
                        ...
                        <a href="http://www.tooplate.com" class="text-white tm-footer-link">Moses O. Opiyo</a> |  Distributed by <a href="https://themewagon.com" class="text-white tm-footer-link">ThemeWagon</a>
                    </p>
                </div>
            </footer>
        </div>
