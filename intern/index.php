				...
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						...
						<div class="main-menubar d-flex align-items-center">
							<nav class="hide">
								<a href="index.php">All about KNDI</a>
								<a href="generic.php">Nutrition Jobs</a>
								<a href="elements.php"> Food & Nutrition News</a>
							</nav>
				...
				<div class="row fullscreen align-items-center justify-content-between">
					<div class="col-lg-6 col-md-7 col-sm-8">
						<div class="banner-content">
							<h1>KENYA NUTRITION &<br> DIETETICS  INSTITUTE.</h1>
					...
					<div class="col-lg-5 col-md-5 col-sm-4">
						<img src="img/mh.png" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="single-address text-center">
							...
							<p>abcdef ghijk lmnop qrst uvwxyz ghijk abcdef lmnop qrst abdef uvwx ghijk lmq rst uvw xyz</p>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="single-address text-center">
